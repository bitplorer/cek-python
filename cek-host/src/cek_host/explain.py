...
_CATALOG: tuple[tuple[tuple[str, ...], Explanation], ...] = (
    ...
    (
        ...
        Explanation(
            ...
            "Host.prod(secret=secrets.token_bytes(32), once=FileOnceBackend(path)).",
            "G8",
        ),
    ),
    (
    ...
    (
        ...
        Explanation(
            ...
            "Construct Host(require_cap=True) or Host.prod(...).",
            "K1",
        ),
    ),
    (
        ...
        Explanation(
            ...
            "Use FileOnceBackend (or later Redis). prod() refuses memory unless allow_memory_stores=True.",
            "K6 / G8",
        ),
    ),
    (
